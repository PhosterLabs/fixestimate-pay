...
export function createDemoEstimate(request: EstimateRequest): EstimateResult {
  ...
  return {
    ...
    professionalRequired: request.category === 'electrical' || request.category === 'roofing',
    difficulty: request.category === 'electrical' || request.category === 'roofing' ? 'professional-only' : 'moderate',
    estimatedTime: request.category === 'electrical' || request.category === 'roofing' ? 'Professional assessment required' : '30–90 minutes after diagnosis',
    ...
    repairSteps: request.category === 'electrical' || request.category === 'roofing'
